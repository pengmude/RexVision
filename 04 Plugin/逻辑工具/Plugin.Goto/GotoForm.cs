...
{
    public partial class GotoForm: FormBase
    {
        private GotoObj mObj ;
        public GotoForm(GotoObj Obj) : base(Obj)
        {
            mObj = Obj;
            InitializeComponent();
        }
        ...
        {
            mObj.mFuncStr = uiLink_FuncStr.Values.Text;
            mObj.mFuncType = (FuncType)uicomb_FuncType.SelectedIndex;
            mObj.mFuncData = uicomb_FuncData.Text;
            mObj.mGoStr = uiLink_Go.Values.Text;
        }
        public override void ObjToForm()
        {
            uiLink_FuncStr.Values.Text = mObj.mFuncStr;
            uicomb_FuncType.SelectedIndex = (int)mObj.mFuncType;
            uicomb_FuncData.Text = mObj.mFuncData;
            uiLink_Go.Values.Text = mObj.mGoStr;
        }
