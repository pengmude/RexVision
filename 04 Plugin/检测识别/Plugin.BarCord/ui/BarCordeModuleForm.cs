...
{
    public partial class BarCordeModForm: FormBase
    {

        private BarCordeModObj mObj;
        ...
        public BarCordeModForm(BarCordeModObj Obj) : base(Obj)
        {
            mObj = Obj;
            InitializeComponent();
        }
        ...
        private void bt_draw_Click(object sender, EventArgs e)
        {
            ...
            else if (cmb_Shape1.SelectedIndex == 4)
            {
                ...
                mObj.m_ModelRegion = new DrawRoi_Info();
        ...
        public override void  FormToObj()
        {
            try
            {
                ...
                //cmbFindMode.DataSource = Enum.GetNames(typeof(FindMode));
        ...
        {
            //mObj.m_FindMode = (FindMode)Enum.Parse(typeof(FindMode), cmbFindMode.SelectedItem.ToString(), false);
        }
