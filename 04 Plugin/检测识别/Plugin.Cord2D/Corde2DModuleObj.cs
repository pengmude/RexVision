...
namespace Plugin.Corde2D
{
    ...
    [DisplayName("读二维码")]
    [Serializable]
    public class Corde2DModObj : ObjBase
    {
        ...
        public override bool RunObj()
        {
            ...
            try
            {
                ...
                //HDataCode2D m_dataCode2d = new HDataCode2D();
                //HTuple m_ResultHandles = new HTuple();
                Find.FindCorde2D(mRImage, m_SymbolXLD, m_DataCodeHandle, m_CordeNum, m_ResultHandles, out m_Corde2DXLD, out m_DecodedDataStrings);
                ...
                Log.Info( Sol.mSol.mProjList[ModInfo.Index].mProjInfo.Name + ":" + ModInfo.Name + ":" + m_DecodedDataStrings );
                //添加检测roi  magical 20170821
                HText roi文字显示 = new HText(ModInfo.Encode, ModInfo.Name, ModInfo.Remarks,HRoiType.文字显示, "green", m_DecodedDataStrings, "mono", 10, 0, 20, new HObject(CoordXLD));
                HRoi roi检测范围 = new HRoi(ModInfo.Encode, ModInfo.Name, ModInfo.Remarks,HRoiType.检测范围, "cyan", new HObject(m_Corde2DXLD));
                  HRoi roi检测点 = new HRoi(ModInfo.Encode, ModInfo.Name,   ModInfo.Remarks,HRoiType.检测点, "blue", new HObject(m_MeasCross), false);
                HRoi roi检测结果 = new HRoi(ModInfo.Encode, ModInfo.Name, ModInfo.Remarks,HRoiType.检测结果, "red", new HObject(m_ResultXLD), false);
                HRoi roi屏蔽范围 = new HRoi(ModInfo.Encode, ModInfo.Name, ModInfo.Remarks,HRoiType.屏蔽范围, "red", new HObject(tempDisableRegion), false);
        ...
        {
           new Corde2DModForm((Corde2DModObj)baseMod).ShowDialog();
        }
