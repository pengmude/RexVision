...
namespace Plugin.FitLine
{
    public partial class FitLineForm: FormBase
    {
        ...
        public override void ObjToForm()
        {
            ...
            tb_CoreX.TextStr = mObj.mOutLine!=null? mObj.mOutLine.MidX.ToString("F4")   :"0";
            tb_CoreY.TextStr = mObj.mOutLine != null ? mObj.mOutLine.MidX.ToString("F4"):"0";
            tb_Angle.TextStr = mObj.mOutLine != null ? mObj.mOutLine.Phi.ToString("F4") :"0" ;
            tb_Dist.TextStr = mObj.mOutLine != null ? mObj.mOutLine.Dist.ToString("F4") :"0";
        }
