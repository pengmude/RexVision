...
namespace RexControl
{
    ...
    /// 图像旋转
    /// </summary>
    public partial class RotateImageControl : UserControl
    {
        ...
        /// 图像旋转事件
        /// </summary>
        public  event RotateImageHandle UserControlValueChanged;
        /// <summary>
        /// 图像旋转委托
        /// </summary>
        public delegate void RotateImageHandle(string str);
